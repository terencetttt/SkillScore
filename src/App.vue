...
:root {
  --bg: #070C24; --card: #0D1540; --card2: #111A4A;
  --border: rgba(255,215,0,0.22); --border2: rgba(255,215,0,0.40);
  --text: #F0F4FF; --muted: rgba(240,244,255,0.65); --dim: rgba(240,244,255,0.30);
  --yellow: #FFD700; --y-dim: rgba(255,215,0,0.14); --y-str: rgba(255,215,0,0.35);
  --green: #34D399; --g-dim: rgba(52,211,153,0.14); --g-bdr: rgba(52,211,153,0.32);
  --red: #FF5555; --r-dim: rgba(255,85,85,0.14); --r-bdr: rgba(255,85,85,0.32);
  --shadow: 0 8px 32px rgba(0,0,0,0.50);
  --font-h: "Outfit", sans-serif; --font-b: "Inter", system-ui, sans-serif; --font-n: "Space Grotesk", sans-serif;
}
...
.logo-hex { width: 32px; height: 32px; background: var(--yellow); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-family: var(--font-h); font-weight: 900; font-size: 16px; color: #070C24; }
...
.w-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--green); box-shadow: 0 0 6px var(--green); }
.btn-connect { font-size: 12px; font-weight: 700; color: #070C24; background: var(--yellow); border: none; padding: 7px 16px; border-radius: 20px; cursor: pointer; transition: all .2s; }
...
.btn-ghost { background: transparent; border: 1px solid var(--border); border-radius: 10px; color: var(--muted); font-size: 12px; padding: 8px 16px; cursor: pointer; transition: all .2s; }
.btn-ghost:hover { border-color: var(--yellow); color: var(--yellow); background: var(--y-dim); }
.input-field { width: 100%; padding: 12px 14px; background: var(--card2); border: 1.5px solid var(--border); border-radius: 10px; color: var(--text); font-size: 14px; outline: none; transition: all .2s; }
...
.verdict-all { background: var(--y-dim); border: 1px solid var(--y-str); color: var(--yellow); }
