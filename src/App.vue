...
[data-theme="light"] {
  ...
  --card:    #FFFFFF;
  --card2:   #E8EEFF;
  --border:  rgba(7,12,36,0.14);
  --border2: rgba(7,12,36,0.28);
  --text:    #070C24;
  --muted:   rgba(7,12,36,0.60);
  --dim:     rgba(7,12,36,0.30);
  --yellow:  #C49000;
  --y-dim:   rgba(196,144,0,0.10);
  --y-str:   rgba(196,144,0,0.25);
  --shadow:  0 8px 32px rgba(7,12,36,0.12);
}
...
.logo-hex { width: 32px; height: 32px; background: var(--yellow); border-radius: 8px; display: flex; align-items: center; justify-content: center; font-family: var(--font-h); font-weight: 900; font-size: 16px; color: var(--bg); flex-shrink: 0; }
...
.mode-btn { background: var(--y-dim); border: 1px solid var(--border); border-radius: 20px; color: var(--yellow); font-size: 11px; font-weight: 600; padding: 5px 14px; cursor: pointer; font-family: var(--font-b); transition: all .2s; }
.mode-btn:hover { background: var(--y-str); }
...
.btn-connect { font-size: 12px; font-weight: 700; font-family: var(--font-b); color: var(--bg); background: var(--yellow); border: none; padding: 7px 16px; border-radius: 20px; cursor: pointer; transition: all .2s; }
